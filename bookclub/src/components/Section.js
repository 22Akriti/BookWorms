...
const Section = () => {
  return (
    <SectionContainer>
      ...
      <SectionWrapper bgColor="black"> {/* Grayish beige */}
        <ImagesContainer>
          <ImageWrapper>
        ...
        <ButtonsContainer>
          ...
          <Button to="#">Join a Club</Button> {/* Replace with actual link if needed */}
          <Button to="#">Discover New Books</Button> {/* Replace with actual link if needed */}
        </ButtonsContainer>
      </SectionWrapper>

    {/*Second Section */}
      <SectionWrapper bgColor="#390000"> {/* White */}
      <ImageWrapper2>
  ...
  <BookOfTheMonthSection>
    ...
    <BookOfTheMonthContent>
      ...
      <BookText>
        ...
        <AddToShelfButton>Add to Your Shelf</AddToShelfButton>
      </BookText>
    </BookOfTheMonthContent>
  </BookOfTheMonthSection>
</SectionWrapper>
